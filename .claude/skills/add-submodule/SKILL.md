...
5. **Optionally Update and initialize**: Upon completion, ask the user if you should run git submodule update --init to initialize the new submodule in the current repo
